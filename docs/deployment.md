...
URL: `https://libreria.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `libreria.demo.federicocalo.dev`
...
- Output directory: `dist/libreria/browser`
...
URL: `https://fedcal.github.io/federico-demo-libreria/`
...
- `base: /federico-demo-libreria/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `libreria-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   libreria-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `libreria-docs.federicocalo.dev`
