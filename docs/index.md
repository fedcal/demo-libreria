...
hero:
  ...
  actions:
    - theme: brand
      text: Demo live
      link: https://libreria.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-libreria
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Libreria.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Libreria** in Italia.
...
Il mercato italiano delle PMI per **Libreria** ha caratteristiche specifiche:
...
```bash
git clone https://github.com/fedcal/federico-demo-libreria.git
cd federico-demo-libreria
npm install
npm start
# → http://localhost:4200
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-libreria)
